...
## ВАЖНОЕ ДОПОЛНЕНИЕ
### нужен .env файл можно скопировать .env.example и переименовать в просто .env
### Установить Компосер!!! composer install
### Установить NPM!!!! npm install
### ВЫПОЛНИТЬ php artisan migrate для создания БД!!!!
### После этого выполняете в 2ух терминалах Bash следующие команды php artisan serve и npm run dev
...
### в строке верхней надо к адресу добавить /books чтобы перейти на рабочую вкладку, потом она будет основной, пока вот так :\
